//
//  MySuperAppViewController_iPad.m
...
@implementation MySuperAppViewController_iPad
...
{
    // PUT me
    NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithObjectsAndKeys:@"Newton Corp Co-Founder, http://www.newton-corp.fr, Viadeo iOS Lead Developer, http://www.viadeo.com", @"headline", @"Software Engineer", @"introduction", @"Football, Cinema", @"interests", nil];
