//
//  MySuperApplication_iPadTests.m
//  MySuperApplication_iPadTests
//
//  Created by Viadeo on 20/09/11.
//  Copyright (c) 2011 Viadeo. All rights reserved.
//

#import "MySuperApplication_iPadTests.h"

#define VD_CLIENT_ID @"CLIENT_ID"
#define VD_CLIENT_SECRET @"CLIENT_SECRET"

@implementation MySuperApplication_iPadTests
...
- (void)testExample
{
    //STFail(@"Unit tests are not implemented yet in MySuperApplication_iPadTests");
}
